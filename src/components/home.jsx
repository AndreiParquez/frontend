  ...
  return (
    <div className="flex-grow md:p-4 p-2 md:mt-20 mt-16">
      <div className="flex flex-col md:flex-row gap-4 clipped-bg">
        <div className="flex-1 text-white rounded md:p-36 p-10 ">
        ...
        <div className="flex-1 p-4 rounded flex items-center justify-center">
          <img src={hero1} alt="Game Logo" className="w-full h-auto max-w-md" />
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4  clipped-bg">
        ...
        <div className="md:flex-1 p-4 rounded flex items-center justify-center">
          <img src={hero3} alt="Game Logo" className="w-full h-auto max-w-md" />
        </div>
      </div>
      
      <div className="flex flex-col md:flex-row gap-4">
        <div className="flex-1 p-4 rounded flex items-center justify-center">
          <img src={hero4} alt="Game Logo" className="w-full h-auto max-w-md" />
        </div>
        <div className="flex-1 text-white rounded md:p-36 p-10">
